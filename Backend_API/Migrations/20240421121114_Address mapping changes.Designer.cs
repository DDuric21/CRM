...
namespace Backend_API.Migrations
{
    ...
    [Migration("20240421121114_Address mapping changes")]
    partial class Addressmappingchanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_API.Data.Model.Customer", b =>
                {
                    ...
                    b.Property<string>("LegalAddressId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Backend_API.Data.Model.CustomerAddresses", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Backend_API.Data.Model.CustomerAddresses", b =>
                {
                    b.HasOne("Backend_API.Data.Model.Address", null)
                        .WithMany()
                        .HasForeignKey("AddressID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend_API.Data.Model.Customer", null)
                        .WithMany()
